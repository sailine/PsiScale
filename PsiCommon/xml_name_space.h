...
{
	extern "C" const TCHAR* XML_USERS_INFO;
	extern "C" const TCHAR* XML_USER_INFO;
	extern "C" const TCHAR* XML_USER_NAME;
	extern "C" const TCHAR* XML_USER_PASSWORD;
	extern "C" const TCHAR* XML_USER_UID;
	extern "C" const TCHAR* XML_USER_USERID;
	extern "C" const TCHAR* XML_USER_PINYIN;
	extern "C" const TCHAR* XML_USER_NATIONALITY;
	extern "C" const TCHAR* XML_USER_BIRTHDATE;
	extern "C" const TCHAR* XML_USER_SEX;
